...
class Prices extends React.Component {
    ...
    render() {
        ...
        if (this.state.currency === 'USD') {
            ...
            list = <li className="list-group-item">
                Bitcoin rate for {this.props.bpi.bpi.GBP.description} : <span className="badge badge-primary">{this.props.bpi.bpi.GBP.code}</span> <strong>{this.props.bpi.bpi.GBP.rate}</strong>
            </li>
